...
**frequentist statistics: punctual prediction. bayesian stats does not give you punctual predictions**
**choose the prior you want**

Questions to be answered (but see guidance below):
1- Write a paragraph discussing how assessment of prediction performance is different in Bayesian vs. frequentist models
**Assessment of prediction performance is done by e.g. calculating predictive posterior in Bayesian statistics, while calculating RMSE or looking at the residuals in frequentist statistics. The predictive posterior is here a distribution of how many questions are answered correctly. It combines all the possible parameter values in a way that reflects how probable those parameter values are.**
